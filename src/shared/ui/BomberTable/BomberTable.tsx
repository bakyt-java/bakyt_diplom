...
import { BombersViewDataType } from "@/views/BombersView/constants";
...
interface BomberTableProps {
	dataSource: BombersViewDataType[];
}

export const BomberTable: React.FC<BomberTableProps> = ({ dataSource }) => {
	return (
			...
			>
				<TableHead>
					<TableRow>
						...
						<StyledTableCell align='center'>Г</StyledTableCell>
